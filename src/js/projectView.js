    ...
    data.forEach(project => {
        container.insertAdjacentHTML("afterbegin", `
            <div data-project-id="${project.title}" class="card">
                ...
                <div class="image">
                    <img src="../src/img/${project.thumbnail}" alt>
                </div>
                ...
                <div class="flex_right">
                    <!-- Bouton voir plus -->
                    <button class="seemore">EN SAVOIR PLUS
...
function openDetails(project) {
    ...
    document.body.insertAdjacentHTML("beforeend", `
        <div data-for-project-id="${project.title}" class="pop-up">
            <div>
                <span class="close">&times;</span>
                
                <img class="image_visuel" src="../src//img/image.jpg" alt>
